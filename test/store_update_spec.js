...
describe('Store::Update', function () {
    ...
    it('should execute an update query', function (done) {
        model.save(null, {
    ...
    it('should pass an hstore as the first parameter to the query', function (done) {
    ...
    it('should pass an id as the second parameter to the query', function (done) {
